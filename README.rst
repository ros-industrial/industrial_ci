...
* `VERBOSE_CATKIN_COMMANDS` (default: not set): If set, the output of some `catkin {build, run_tests}` commands will be verbose.
* `QUIET_SLEEP_LENGTH` (default: 60): Second to interval between print. Not used when `VERBOSE_CATKIN_COMMANDS` is on.
