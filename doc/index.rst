...
* **PRERELEASE_EXCLUDE_PKG** (default: not set): List of names of released 'packages' from the distribution file which should be excluded from the overlay workspace.
