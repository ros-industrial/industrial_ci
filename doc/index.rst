...
* **CLANG_FORMAT_EXECUTABLE** (default: ``clang-format``): Version of clang-format to install and use (relates to both the apt package name as well as the executable), e.g., ``CLANG_FORMAT_EXECUTABLE=clang-format-3.9``.
