...
* **CODE_COVERAGE** (default: not set. Value range: [``codecov.io`` | ``coveralls.io``]): Generate a coverage report and upload it to `codecov.io <https://codecov.io/>`__ or `coveralls.io <https://coveralls.io>`__.
