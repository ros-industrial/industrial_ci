...
function prepare_ros_prerelease() {
    ...
    for e in TRAVIS OS_NAME OS_CODE_NAME OS_ARCH PRERELEASE_DOWNSTREAM_DEPTH PRERELEASE_REPONAME PRERELEASE_EXCLUDE_PKG ROSDISTRO_INDEX_URL PRERELEASE_DISTRO; do
...
function run_ros_prerelease() {
    ...
    local exclude_pkg=${PRERELEASE_EXCLUDE_PKG:-""}
